...
public class EntityVariantDataFactory {
    ...
    public static Identifier loadBaseTexture(EntityRenderer renderer, EntityRenderState state) {
        // Not every entity renderer is a LivingEntityRenderer - GeckoLib's GeoEntityRenderer extends
        // plain EntityRenderer, so the old unconditional cast threw a ClassCastException on every
        // radar update for mods like UntitledDuckMod.
